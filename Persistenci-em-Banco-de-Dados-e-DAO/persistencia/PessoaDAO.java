...
public class PessoaDAO {
	...
	public static PessoaDAO getInstance() throws ClassNotFoundException, SQLException, SelectException{//ClassNotFoundException,SQLExcpetion,SelectException
		if(instance == null) {
			instance = new PessoaDAO();
		}
		return instance;
	}
	private int selectNewId() throws SelectException{//Select Exception
		try {
	...
	public void insert(Pessoa pessoa) throws InsertException, SelectException{//InserException
		try {
	...
	public void delete(Pessoa pessoa) throws DeleteException{//DeleteException
		enderecoDAO.delete(pessoa.getEndereco());
		try {
			delete.setInt(1, pessoa.getId());
			delete.executeUpdate();
		}catch(SQLException e) {
			throw new DeleteException("Erro ao deletar pessoa");
		}
	}
	public List<Pessoa> selectAll() throws SelectException{//SelectException
	...
	public void update(Pessoa pessoa) throws UpdateException{//UpdateException
		try {
