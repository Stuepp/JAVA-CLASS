	...
	public void adicionarAnimal(Animal animal) throws EspacoIndisponivelException, EhPeixeException{
		if(!(animal instanceof Peixe)) {
			if(espacoDisponivel() >= (animal.calculaEspacoOcupado()*0.7)) {
				...
				throw new EspacoIndisponivelException("A espaço insuficiente para o animal");
			}
		} else {
			throw new EhPeixeException("O animal é peixe e não pode ser alocado em um viveiro");
		}
	}
